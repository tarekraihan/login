...
if(isset($_POST['btnSubmit']))
{
    ...
    $feedback=$main->insert_category($faq_name);
}

if(isset($_GET['faq_category_id']))
{
    $type_id=$_GET['faq_category_id'];
    $feedback=$main->Delete_Single_Row($type_id,$table="tbl_faq_category",$field_name="faq_category_id");
}
?>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <form action=" " method="post">
                            <div class="form-group" style="margin-top:0px;">
                                ...
                                <input  type="text" name="txtCategory" class="form-control category_name_insert">
                            </div>
                            <input type="submit" class="btn btn-success pull-right" value="Create" name="btnSubmit" />
                        </form>
                    </div>
